...
// === Konfiguration laden: Script-spezifische Einstellungen aus script_config.json ===
var config = loadScriptConfigForThisScript();
function loadScriptConfigForThisScript() {
    // Bestimme den Pfad der aktuellen .jsx-Datei
    var scriptFile = new File($.fileName);
    // Konfigurationsdatei liegt im Ordner ../config relative zum Skriptordner
    ...
    try {
        ...
        for (var i = 0; i < scripts.length; i++) {
            // Prüfe, ob der aktuelle Skriptpfad (vollständig) im Konfigurationswert enthalten ist
...
// Aus der geladenen Konfiguration werden die spezifischen Werte übernommen (Falls nicht gesetzt, bleiben sie leer)
...
// -----------------------------
// Hier folgt der restliche Originalcode des Skripts
// -----------------------------

// Die Hauptlogik: Erzeugen des FitImage-Dialogs und die Verarbeitung
try {
