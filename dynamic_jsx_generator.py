...
def create_temp_jsx_with_config(
    ...
    js_kw_logic   = _js_string((keyword_logic or "AUTO").upper())  # <— NEU
    ...
    replacements = {
        ...
        "/*PYTHON_INSERT_KW_LOGIC*/":          js_kw_logic,    # <— NEU (Fallback)
    ...
    try:
        ...
        # Zusammenfassung ins Debug – **nur Rohwerte**
        debug_print(
            "[DynamicJSX] Temporary JSX created: {path} "
            "(keywordCheckEnabled={kw_enabled}, keywordCheckWord={kw_word}, keywordLogic={kw_logic}, "
            ...
            "logFolderPath={logdir}, DEBUG_OUTPUT={dbg})".format(
                ...
                kw_logic=(keyword_logic or "AUTO").upper(),
...
if __name__ == "__main__":
    ...
    temp_jsx = create_temp_jsx_with_config(
        ...
        keyword_check_word="Rueckseite&!Preview",
        ...
        logfiles_dir="/tmp",
        debug_output=True,
        keyword_logic="AUTO",   # "AUTO" | "ANY" | "ALL"
    )
